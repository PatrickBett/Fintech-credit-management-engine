from .views import CustomerListCreateView, ProductListCreateView, CreditProfileListCreateView, CustomerKYCListCreateView, RefereeListCreateView,CustomerStatusUpdateView
